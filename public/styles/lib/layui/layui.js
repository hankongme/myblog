...
function(e) {
    ...
    t.fn.use = function(e, t, a) {
        function s(e, t) {
            var n = "PLaySTATION 3" === navigator.platform ? /^complete$/: /^(complete|loaded)$/; ("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.modules[m] = t, y.removeChild(v),
            function i() {
        ...
        var m = e[0],
        p = 0;
        if (a = a || [], o.host = o.host || (d.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length || layui["layui.all"] && l[m]) return "function" == typeof t && t.apply(layui, a),
        f;
        ...
        } () : (y.appendChild(v), !v.attachEvent || v.attachEvent.toString && v.attachEvent.toString().indexOf("[native code") < 0 || u ? v.addEventListener("load",
        function(e) {
            s(e, h)
        },
    ...
    t.fn.link = function(e, t, i) {
        ...
        "function" == typeof t && !
        function d() {
            return++f > 1e3 * o.timeout / 100 ? r(e + " timeout") : void(1989 === parseInt(u.getStyle(n.getElementById(c), "width")) ?
            function() {
                t()
            } () : setTimeout(d, 100))
        } ()
    ...
    t.fn.event = function(e, t, n) {
        ...
        return layui.each(o.event[l], a),
        u[0] && layui.each(o.event[t], a),
        r
    },
    e.layui = new t
} (window);
