...
layui.define("jquery",
    function (i) {
        ...
        s.prototype.set = function (i) {
            ...
            s.prototype.tabAdd = function (i, a) {
                var e = t(".layui-tab[lay-filter=" + i + "]"),
                    l = e.children(".layui-tab-title").children('.dv1'),
                    n = e.children(".layui-tab-content");
                return l.append("<li>" + (a.title || "unnaming") + "</li>"),
                    n.append('<div class="layui-tab-item">' + (a.content || "") + "</div>"),
                    y.tabAuto(),
                    this
            },
            s.prototype.tabDelete = function (i, a) {
                var e = t(".layui-tab[lay-filter=" + i + "]"),
                    l = e.children(".layui-tab-title").children('.dv1').find(">li").eq(a);
                return y.tabDelete(null, l),
                    this
            },
            s.prototype.tabChange = function (i, a) {
                var e = t(".layui-tab[lay-filter=" + i + "]"),
                    l = e.children(".layui-tab-title").children('.dv1').find(">li").eq(a);
                return y.tabClick(null, a, l),
                    this
            };
        var o = ".layui-nav",
            c = "layui-nav-item",
            ...
            y = {
                tabClick: function (i, a, s) {
                    var o = s || t(this),
                        ...
                        u = c.attr("lay-filter");
                    o.addClass(l).siblings().removeClass(l),
                        r.eq(a).addClass(n).siblings().removeClass(n),
                        layui.event.call(this, e, "tab(" + u + ")", {
                            elem: c,
                            index: a
                        })
                        if($(this).parent().hasClass('dv1')){
                            ...
                            $($('.count')[idx]).addClass('layui-this');    
                            $($('.count')[idx]).parent().parent().addClass('layui-nav-itemed');     
                        }
                },
                tabDelete: function (i, a) {
                    ...
                    e.hasClass(l) && (e.next()[0] ? y.tabClick.call(e.next()[0], null, n + 1) : e.prev()[0] && y.tabClick.call(e.prev()[0], null, n - 1)),
                        e.remove(),
                        o.eq(n).remove()
                },
                tabAuto: function () {
                    ...
                    t(".layui-tab").each(function () {
                        var s = t(this),
                            o = s.children(".layui-tab-title").children('.dv1'),
                ...
                clickThis: function () {
                    var i = t(this),
                        a = i.parents(o),
                        n = a.attr("lay-filter");
                    i.find("." + d)[0] || (a.find("." + l).removeClass(l), i.addClass("layui-nav-itemed"), layui.event.call(this, e, "nav(" + n + ")", i));
                    if(!i.find("." + d)[0]){
                        ...
                        if (_width > 750) {
                            ...
                            var marginLeft = -parseInt($('.dv1').css('margin-left'));
                            if (_this > index) {
                                $(".dv1").animate({
                    ...
                    if ($(this).hasClass('layui-nav-animation')) {
                        $('.x-slide_left').children('.fa-arrow-left').css('display', 'inline-block');
                        $('.x-slide_left').children('.fa-list').css('display', 'none');
                        setTimeout(function () {
                            $('.x-slide_left').children('.fa-arrow-left').css({transform: 'rotate(0deg)'});
                        }, 1);
                    }
                ...
                clickChild: function () {
                  ...
                  $($('.layui-tab-title .layui-this')[0]).attr('idx',$(this).attr('idx'))
                    return !1;
                },
                showChild: function () {
                    var i = t(this),
                ...
                nav: function () {
                    ...
                    t(o).each(function () {
                        var a = t(this),
                            ...
                            f = a.find("." + c);
                        a.find("." + r)[0] || (a.append(o), f.on("mouseenter",
                            function () {
                                p.call(this, o, a)
                            }).on("mouseleave",
                            function () {
                                a.hasClass(u) || (clearTimeout(e), e = setTimeout(function () {
                                        a.find("." + d).removeClass(n),
                                            a.find("." + h).removeClass(h + "d")
                                    },
                                    300))
                            }), a.on("mouseleave",
                            function () {
        ...
        var p = new s,
            b = t(document);
        p.init();
        var v = ".layui-tab-title div li";
        b.on("click", v, y.tabClick),
            b.on("click", y.hideTabMore),
