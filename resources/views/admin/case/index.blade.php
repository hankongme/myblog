            ...
            <div class="panel-heading">
                ...
                <div class="panel-actions">
                    ...
                    <button type="button" class="btn btn-primary"
                            onclick="edit('添加','{{url(__ADMIN_PATH__.'/case/create')}}')">
            ...
            <div class="panel-body nav-tabs-animate">
                    <table  class="table table-bordered table-hover dataTable table-striped width-full text-nowrap" id="dataTable"  data-paging="false" data-ordering="false" data-info="false">
                        ...
                        <tr>
                            ...
                            <th data-field="cover_img">图片</th>
                            <th data-field="avtivity_type">分类</th>
                        ...
                        @if($data['data'])
                            @foreach($data['data'] as $v)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{$v['cover_img']}}" alt="" width="50px">

                                    </td>

                                    <td>
                                        {{$v['category_name'] or '顶级分类'}}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-xs btn-white"
                                           onclick="edit('编辑','{{url(__ADMIN_PATH__.'/case',['edit','id',$v['id']])}}')"
                                        ...
                                        <a class="confirm ajax-get btn btn-xs btn-white"
                                           href="{!! url('admin/case/del',['id',$v['id']]) !!}"
