    ...
    <main class="site-page">
        ...
        <div class="panel">
            ...
            <div class="panel-body container-fluid">
                ...
                <div class="form-group">
                    {!! Form::label('title','是否MD',['class'=>'col-sm-3 control-label']) !!}
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::textarea('brief',$data['brief'],['id'=>'brief']) !!}
                    </div>
                </div>
...
@section('stylejs')
    ...
    <script>
        ...
        var ue2 = UE.getEditor('brief',{
            allowDivTransToP: false,
            toolbars:[['fullscreen', 'source', 'undo', 'redo', 'bold', 'italic', 'underline','insertcode']],
            initialFrameHeight:100
        });
        DCNET.setValue('is_best', '{{$data['is_best'] or 1}}');
        DCNET.setValue('is_top', '{{$data['is_top'] or 0}}');
        DCNET.setValue('is_md', '{{$data['is_md'] or 0}}');
    </script>
