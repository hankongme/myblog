            ...
            <div class="panel-heading">
                ...
                <div class="panel-actions">
                    ...
                    <button type="button" class="btn btn-primary"
                            onclick="edit('添加','{{url(__ADMIN_PATH__.'/category')}}')">
                    ...
                    @if($data['data'])
                        @foreach($data['data'] as $v)
                            <tr>
                                ...
                                <td>{{$v['id']}}</td>
                                <td>
                                    <a href="{{url(__ADMIN_PATH__.'/category/index',[$v['id']])}}">
                                        {{$v['name']}}
                                    </a>
